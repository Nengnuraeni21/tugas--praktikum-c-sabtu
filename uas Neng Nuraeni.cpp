...
// Fungsi untuk menjalankan proses pengelasan dengan array ketebalan
void jalankanProsesPengelasan(int ketebalanPengelasan[], int jumlahKetebalan) {
...
int main() {
    ...
    jalankanProsesPengelasan(ketebalanPengelasan, jumlahKetebalan);
